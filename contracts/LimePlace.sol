...
contract LimePlace is ReentrancyGuard {
    ...
    function listNft(address _nftContract, uint256 _tokenId, uint256 _price) public payable nonReentrant {
        ...
        //todo use approve instead of transfer
        
        IERC721(_nftContract).transferFrom(msg.sender, address(this), _tokenId);
        _marketOwner.transfer(LISTING_FEE);
        _nftCount.increment();

        //todo optimize main storage
    ...
    function getListedNfts() public view returns (NFT[] memory) {
        ...
        uint nftsIndex = 0;
        //todo refactor main storage structs in order to skip for loops!!!
    ...
    //todo refactor to getNftsByUser()
